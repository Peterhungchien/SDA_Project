...
def train_lightgbm_model(df: pd.DataFrame, target_column: str, params: dict = {}):
    """
    Train a LightGBM model with hyperparameter tuning and cross-validation.
    ...
    :return: Best trained LightGBM model from GridSearchCV.
    """
    ...
    if not params:
        params = load_config(config_path)['model_training']['lightgbm']
